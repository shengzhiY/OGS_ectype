...
Timer* Timer::instance()
{
    ...
    Timer::Timer()
    {
        ...
        {
            _secsPerTick = 1.0;
			OSG_DEBUG <<"Error: Timer::Timer() unable to use QueryPerformanceFrequency, "<<std::endl;
			OSG_DEBUG <<"timing code will be wrong, Windows error code: "<<GetLastError()<<std::endl;
        }
    ...
    Timer_t Timer::tick() const
    {
        ...
        {
			OSG_DEBUG <<"Error: Timer::Timer() unable to use QueryPerformanceCounter, "<<std::endl;
			OSG_DEBUG <<"timing code will be wrong, Windows error code: "<<GetLastError()<<std::endl;
            return 0;
        }
    }
