...
{
	OSG_DEBUG <<"Doing remove operation"<<std::endl;
...
{
	OSG_DEBUG <<"Doing remove named operation"<<std::endl;
...
{
	OSG_DEBUG <<"Doing remove all operations"<<std::endl;
...
void OperationThread::setDone(bool done)
{
    ...
    if (done)
    {
		OSG_DEBUG <<"set done "<<this<<std::endl;

        {
            OpenThreads::ScopedLock<OpenThreads::Mutex> lock(_threadMutex);
            if (_currentOperation.valid())
            {
				OSG_DEBUG <<"releasing "<<_currentOperation.get()<<std::endl;
...
{
	OSG_DEBUG <<"Cancelling OperationThread "<<this<<" isRunning()="<<isRunning()<<std::endl;
    ...
    if( isRunning() )
    {
		...
		OSG_DEBUG <<"Doing cancel "<<this<<std::endl;
        {
            OpenThreads::ScopedLock<OpenThreads::Mutex> lock(_threadMutex);

            if (_operationQueue.valid())
            {
				OSG_DEBUG << "_operationQueue block release " << this << std::endl;
	...
	OSG_DEBUG <<"OperationThread::cancel() thread cancelled "<<this<<" isRunning()="<<isRunning()<<std::endl;
...
{
	OSG_DEBUG <<"Doing run "<<this<<" isRunning()="<<isRunning()<<std::endl;
    ...
    do
    {
        ...
        if (operation.valid())
        {
			...
			OSG_DEBUG <<"Doing op "<<_currentOperation->getName()<<" "<<this<<std::endl;
	...
	OSG_DEBUG <<"exit loop "<<this<<" isRunning()="<<isRunning()<<std::endl;
